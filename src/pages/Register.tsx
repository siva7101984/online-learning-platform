      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-500 mt-1">Join LearnHub and start learning today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <label className={`flex-1 flex items-center gap-2 px-4 py-2.5 rounded-lg border cursor-pointer transition-colors ${role === "student" ? "border-blue-500 bg-blue-50" : "border-gray-300"}`}>
                ...
                <label className={`flex-1 flex items-center gap-2 px-4 py-2.5 rounded-lg border cursor-pointer transition-colors ${role === "admin" ? "border-blue-500 bg-blue-50" : "border-gray-300"}`}>
